...
function showProfil(sym, ex) {
  ...
  // Şirket logosu — kendi proxy endpoint'imizden
  ...
  if(_logoEl) {
    ...
    _img.src = '/api/scan?action=logo&sym=' + encodeURIComponent(sym) + '&ex=' + encodeURIComponent(_prfEx || 'bist');
    _logoEl.innerHTML = '';
...
async function loadQuoteData(sym, ex) {
  try {
