...
description: Use this agent for mobile-first design philosophy and implementation guidance — touch targets, gestures, platform conventions (iOS/Android), thumb-zone ergonomics, and mobile UX patterns.
model: sonnet
---
